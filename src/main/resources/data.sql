...
VALUES
('web', '$2a$10$HuuzUjO5OfRwXDAI0zjnlu.TFt5dB66ag4tEFokkxxwzsHJh1dXLm', 'read', 'authorization_code,password,refresh_token,implicit', '900', '{}');

-- password encoded with BCript (new BCryptPasswordEncoder()).encode("dazito.com"))
INSERT INTO `account` (`id`, `password`, `username`) VALUES ('	1	', '$2a$10$FOqrjeX9h7VGscD2oqMtXeHM4p8UPuVUcD3GuMadJgnDMq0SOJDDC', 'dazito');
